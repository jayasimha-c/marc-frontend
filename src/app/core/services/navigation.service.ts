  ...
  private getNavigation(): NavItem[] {
    return [
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              { id: 'simulation', title: 'Simulation', icon: 'experiment', link: '/acm/risk-analysis/simulation/online', type: 'item', authorities: ['OP_RA_SIMULATION'] },
      ...
      },
      {
        ...
        icon: 'reconciliation',
        type: 'submenu',
        authorities: ['OP_ICM_RULES', 'DIS_OP_ICM_RULES', 'OP_ICM_CONTROLS', 'OP_ICM_EXECUTION'],
        children: [
          { id: 'icm-rules', title: 'Rules', icon: 'file-text', link: '/icm/rules', type: 'item', authorities: ['OP_ICM_RULES', 'DIS_OP_ICM_RULES'] },
          { id: 'icm-controls', title: 'Controls', icon: 'safety-certificate', link: '/icm/controls', type: 'item', authorities: ['OP_ICM_CONTROLS'] },
          { id: 'icm-execution', title: 'Execution', icon: 'rocket', link: '/icm/execution', type: 'item', authorities: ['OP_ICM_EXECUTION'] },
          { id: 'icm-master-data', title: 'Master Data', icon: 'database', link: '/icm/master-data', type: 'item', authorities: ['OP_ICM_MASTER_DATA'] },
        ],
      },
      {
        id: 'central-users',
